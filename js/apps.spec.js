...
angular
  .module('yvoiceSpec', ['yvoiceService', 'yvoiceLicenseService'])
  .config([
    '$qProvider',
    function($qProvider) {
  ...
  .controller('SpecController', [
    ...
    function(
      ...
      ctrl.consumerKey = function() {
        LicenseService.consumerKey($scope.licenseType)
          .then(function(value) {
      ...
      ctrl.waveVer1 = function() {
        ...
        AquesService.wave($scope.encoded, phont, speed, options)
          .then(function(value) {
            $scope.waveResult = 'ok';
          })
          ['catch'](function(err) {
      ...
      ctrl.play1AqVer1 = function() {
        ...
        // wave
        AquesService.wave($scope.play1Encoded, phont, speed, woptions)
          .then(function(bufWav) {
            // play
            AudioService1.play(bufWav, poptions)
              .then(function(value) {
      ...
      ctrl.record1AqVer1 = function() {
        ...
        AquesService.wave($scope.play1Encoded, phont, speed, woptions)
          .then(function(bufWav) {
            // play
            AudioService1.record($scope.wavFilePath1, bufWav, poptions)
              .then(function(value) {
      ...
      ctrl.play2AqVer1 = function() {
        ...
        // wave
        AquesService.wave($scope.play2Encoded, phont, speed, woptions)
          .then(function(bufWav) {
            // play
            AudioService2.play(bufWav, poptions)
              .then(function(value) {
      ...
      ctrl.record2AqVer1 = function() {
        ...
        AquesService.wave($scope.play2Encoded, phont, speed, woptions)
          .then(function(bufWav) {
            // play
            AudioService2.record($scope.wavFilePath2, bufWav, poptions)
              .then(function(value) {
