...
function showSystemWindow() {
  ...
  var _a = this.appCfg.systemWindow,
    width = _a.width,
    height = _a.height;
  var acceptFirstMouse = this.appCfg.acceptFirstMouse;
...
function showAboutWindow() {
  ...
  localShortcut.register(w, 'Command+Q', function() {
    electron_1.app.quit();
  });
  localShortcut.register(w, 'Command+W', function() {
    w.close();
  });
}
