...
gulp.task('test', gulp.series('_handleError', '_platform:darwin', 'tsc:debug', _buildAppIfNotExist, '_test', '_notify', '_kill'));
gulp.task(
  'test:rebuild',
  gulp.series('_handleError', '_platform:darwin', 'tsc:debug', '_rm:package', '_package:debug', '_unpacked', '_test', '_notify', '_kill')
);
