# 0.7.5 (in test)
* 詳細な説明のあるリリースサイトからダウンロードしない人向けに、リリースファイルにPDFのREADME (1.8MB)を追加。
* リリースファイルに含まれるversionファイルの中身をアプリバージョンに変更。
* セキュリティissue対応で、利用しているライブラリを更新。
* ヘルプ、メニュー、内部構造の微更新。
    * これらの修正で、アプリが8MB、zipのリリースファイルが3.7MBほどサイズ増加。メモリ使用量はトータルでは横ばい。
